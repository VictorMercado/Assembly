...
extern _scanf                                                ;External C++ function for reading from the standard input device

global _floating_point_io                                    ;This makes floating_point_io callable by functions outside of this file.
...
goodbye db "I hope you like working with 8-byte numbers while we wait for the 128-bit X86 processor.  "
        db "Then you'll enjoy 16 byte floating point numbers.", 10, 0
...
_floating_point_io:                                          ;Entry point.  Execution begins here.
...
call       _scanf                                            ;Call a library function to do the input work
