...
gcc -c -m64 -Wall -o display_array.o display_array.c -fno-pie -no-pie -std=c11

g++ -c -m64 -o driver.o driver.cpp -fno-pie -no-pie -std=c++17

g++ -m64 -o TimedArraySort driver.o sort.o manager.o get_frequency.o atof.o random_fill_array.o display_array.o -fno-pie -no-pie -std=c++17
